                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default" title="申报装箱" onclick="packing()"><i
                                        class="fa fa-refresh"></i> 申报装箱
                                </button>
                                <%--document.getElementById('exportForm').submit()--%>
                            </div>
                        </div>
                        ...
                        <form id="exportForm" action="/cargo/packing/toPacking.do" method="post">
                            <c:forEach items="${page.list}" var="o" varStatus="status">
                                <tr class="odd" onmouseover="this.className='highlight'"
                                    ...
                                    <td><input type="checkbox" name="id" value="${o.id}/${o.state}"/></td>
                                    <td>${o.id}</td>
                                    <td align="center">
                                            ${o.proNum}/${o.extNum}
                                    </td>
