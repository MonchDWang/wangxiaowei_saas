                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${page.list}" var="o" varStatus="status">
                        <tr>
                            ...
                            <td>${o.seller}</td>
                            <td><a href="${ctx}/cargo/packing/toView.do?id=${o.packingListId}">${o.packingListId}</a></td>
                            <td>
                                    ${o.buyer}
                            </td>
                            <td>${o.invoiceNo}</td>
                            ...
                            <td>
                                ...
                                <%--<a href="${ctx }/cargo/contractProduct/list.do?contractId=${o.packingListId}">[货物]</a>--%>
                                <%--<a href="${ctx }/cargo/contractProduct/toImport.do?contractId=${o.packingListId}">[上传货物]</a>--%>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
